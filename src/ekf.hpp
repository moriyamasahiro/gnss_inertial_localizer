...
class ekf
{
    ...
    public:
      ...
      void set_GnssVal(const nav_msgs::OdometryConstPtr &gnss, const sensor_msgs::NavSatFixConstPtr &gnss_, const geometry_msgs::TwistWithCovarianceStampedConstPtr &gnss_velocity);
