...
class ekf_publisher
{
    private:
      ...
      message_filters::Subscriber<nav_msgs::Odometry> lgnss_relpos_sub;
      ...
      message_filters::Subscriber<nav_msgs::Odometry> rgnss_relpos_sub;
      ...
      typedef message_filters::sync_policies::ApproximateTime<nav_msgs::Odometry, sensor_msgs::NavSatFix, geometry_msgs::TwistWithCovarianceStamped> GnssSyncPolicy;
